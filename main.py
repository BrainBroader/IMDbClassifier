...
vocabulary = extract_vocabulary(train_data, 200)

rf = RandomForest(10, 100, 5)
rf.fit(train_data, train_target, vocabulary)
predictions = rf.predict(dev_data, vocabulary)
